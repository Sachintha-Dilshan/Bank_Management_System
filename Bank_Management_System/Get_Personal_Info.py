...
class GetPersonalInfo:
   ...
   ########################################
        title = Label(self.frame, text=self.mainTitle, font=("times new roman", 20, "bold"), bg="white",
        ...
        self.insertInfo()
        bntnext=Button(self.frame,text="NEXT",font=("times new roman",20,"bold"),bg="green",fg="white",command=self.next,cursor="hand2",borderwidth=5).place(x=480,y=450)                         
